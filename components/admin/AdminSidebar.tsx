...
export function AdminSidebar() {
  ...
  return (
    <aside
      className={`sticky top-0 h-screen self-start flex flex-col bg-foreground text-white transition-all duration-300 shrink-0 ${
    ...
    >
      ...
      <div className='px-3 py-4 border-t border-white/10 flex flex-col gap-2'>
        ...
        <button
          ...
          className='flex items-center gap-3 px-3 py-2.5 rounded-xl text-white/40 hover:text-rose-400 hover:bg-rose-500/10 transition-all w-full text-left'
        >
