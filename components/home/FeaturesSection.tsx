        ...
        <div className='grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 md:grid-rows-2 gap-4 sm:gap-6 h-auto lg:h-[700px]'>
          ...
          <div className='md:col-span-2 lg:col-span-2 lg:row-span-2 bg-white rounded-[2rem] sm:rounded-[2.5rem] p-6 sm:p-8 lg:p-10 shadow-2xl shadow-primary/5 border border-border/50 flex flex-col justify-between group hover:-translate-y-2 transition-all duration-500 animate-fade-in-up [animation-delay:500ms] opacity-0 fill-mode-forwards'>
            <div>
              ...
              <h3 className='font-heading text-2xl sm:text-3xl font-black text-foreground mb-4 tracking-tight'>
                {features[0].title}
              </h3>
          ...
          <div className='lg:col-span-2 bg-primary rounded-[2rem] sm:rounded-[2.5rem] p-6 sm:p-8 lg:p-10 shadow-2xl shadow-primary/20 flex flex-col justify-center text-white group hover:-translate-y-2 transition-all duration-500 animate-fade-in-up [animation-delay:600ms] opacity-0 fill-mode-forwards relative overflow-hidden'>
            ...
            <h3 className='font-heading text-2xl font-black mb-2 tracking-tight'>
              {features[2].title}
            </h3>
          ...
          {/* Small Cards - Bottom */}
          <div className='bg-white rounded-[2rem] sm:rounded-[2.5rem] p-6 sm:p-8 shadow-xl shadow-primary/5 border border-border/50 group hover:-translate-y-2 transition-all duration-500 animate-fade-in-up [animation-delay:700ms] opacity-0 fill-mode-forwards'>
          ...
          <div className='bg-white rounded-[2rem] sm:rounded-[2.5rem] p-6 sm:p-8 shadow-xl shadow-primary/5 border border-border/50 group hover:-translate-y-2 transition-all duration-500 animate-fade-in-up [animation-delay:800ms] opacity-0 fill-mode-forwards'>
