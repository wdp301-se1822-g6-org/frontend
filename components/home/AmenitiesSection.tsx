      ...
      <div className='max-w-7xl mx-auto relative z-10'>
        <div className='text-center mb-20'>
          ...
          <p className='text-foreground/50 max-w-2xl mx-auto text-lg font-medium leading-relaxed'>
            Chúng tôi không chỉ rửa xe — WAVE mang đến một không gian nghỉ 
            ngơi đẳng cấp với các tiện ích hoàn toàn miễn phí.
          </p>
        </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8'>
          {amenities.map((a, index) => {
            ...
            return (
              <div
                key={a.title}
                className='group relative bg-white/40 backdrop-blur-xl border border-white/80 rounded-[2.5rem] p-10 shadow-xl shadow-primary/5 hover:shadow-primary/10 hover:-translate-y-2 transition-all duration-500 animate-fade-in-up'
